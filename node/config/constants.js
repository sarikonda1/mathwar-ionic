...
module.exports.ROUTE_NOT_FOUND = `Not Found`;
module.exports.SERVER_ERROR_MESSAGE = `Server Error`;
...
module.exports.EMAIL_AVAILABLE_FAILED = `Email already Registered.`;
...
/* Game Settings Start */
module.exports.TOTAL_PLAYERS_COUNT = 2;
module.exports.GAME_INITERVAL = 180;
module.exports.TOTAL_NUMBER_OF_QUESTIONS = 360;
/* Game Settings End */
